...
C10_REGISTER_KERNEL(ElementwiseLinearOp)
  ...
  .dispatchKey({c10::details::TensorParameterDispatchKey{c10::CAFFE2_CPU_TENSOR(), caffe2::TypeMeta::Id<float>()}, c10::details::TensorParameterDispatchKey{c10::CAFFE2_CPU_TENSOR(), caffe2::TypeMeta::Id<float>()}, c10::details::TensorParameterDispatchKey{c10::CAFFE2_CPU_TENSOR(), caffe2::TypeMeta::Id<float>()}});
}
namespace caffe2 {
