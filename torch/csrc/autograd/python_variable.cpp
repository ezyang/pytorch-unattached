...
PyObject *THPVariable_get_trace_fn(THPVariable *self)
{
  ...
  return functionToPyObject(var.trace_fn);
}

int THPVariable_set_trace_fn(THPVariable *self, PyObject *obj)
{
  THPUtils_assertRet(-1, obj == Py_None, "_trace_fn can be only set to None");
  self->cdata->trace_fn = nullptr;
  return 0;
}
...
static struct PyGetSetDef THPVariable_properties[] = {
  ...
  {"trace_fn", (getter)THPVariable_get_trace_fn, NULL, NULL, NULL},
  {"_trace_fn", (getter)THPVariable_get_trace_fn, (setter)THPVariable_set_trace_fn, NULL, NULL},
